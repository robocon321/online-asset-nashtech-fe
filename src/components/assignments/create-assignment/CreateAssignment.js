  ...
  const userColumns = [
    {
      ...
      renderCell: (params) => {
        return (
          <Radio
            checked={
              params.id === (createAssignmentState.popupUser.selected != null
                ? createAssignmentState.popupUser.selected.id
                : false
            )}
            onChange={() => changeSelectUser(params.row)}
            value={params.id}
            name="radio-user"
          />
        );
  ...
  const assetColumns = [
    {
      ...
      renderCell: (params) => (
        <Radio
          checked={
            params.id === (createAssignmentState.popupAsset.selected != null
              ? createAssignmentState.popupAsset.selected.id
              : false
          )}
          onChange={() => changeSelectAsset(params.row)}
          value={params.id}
          name="radio-asset"
        />
      ),
          ...
          <form className={styles["create-assignment"]}>
            <FormControl className={styles["input"]}>
              ...
              <TextField
                ...
                name="user"
                disabled
                value={createAssignmentState.form.userId ? createAssignmentState.popupUser.selected.name : ''}
                InputProps={{
                  endAdornment: (
            ...
            <FormControl className={styles["input"]}>
              ...
              <TextField
                ...
                name="asset"
                disabled
                value={createAssignmentState.form.assetId ? createAssignmentState.popupAsset.selected.name : ''}
                InputProps={{
                  endAdornment: (
